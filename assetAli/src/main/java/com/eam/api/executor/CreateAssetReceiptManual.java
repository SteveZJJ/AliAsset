 ...
 * @version 1.0
 */
public class CreateAssetReceiptManual implements Callable {

    Manual_CreateHeader header;
    HttpServletResponse response;

    public CreateAssetReceiptManual(Manual_CreateHeader header, HttpServletResponse response) {
        this.header = header;
    ...
    public Object call() throws Exception {
        AliResultProcedure resp =  GetService.getInstance().getMybatisReceiptService().createAssetReceiptManual(header);
