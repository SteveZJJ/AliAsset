...
public class CreateRecvLine implements Callable {
	private final Logger logger = LoggerFactory.getLogger(getClass());
	private Receipt_CreateLine recvLine;
	HttpServletResponse response;
	
	public CreateRecvLine(Receipt_CreateLine recvLine,HttpServletResponse response){
	...
	public Object call(){
		...
		AliResultProcedure res1 = GetService.getInstance().getMybatisReceiptService().createRecvLine(recvLine);
